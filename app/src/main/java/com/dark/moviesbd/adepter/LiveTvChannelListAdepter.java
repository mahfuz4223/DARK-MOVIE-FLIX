...
import com.dark.moviesbd.Home;
import com.dark.moviesbd.LiveTv;
import com.dark.moviesbd.Player;
import com.dark.moviesbd.R;
import com.dark.moviesbd.EmbedPlayer;
...
public class LiveTvChannelListAdepter extends RecyclerView.Adapter<LiveTvChannelListAdepter.myViewHolder> {
    ...
    public int getItemViewType(int position) {
        return (position == mData.size()) ? R.layout.show_all_live_tv_channels : R.layout.live_tv_channel_item;
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view;
        if(viewType == R.layout.live_tv_channel_item){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.live_tv_channel_item, parent, false);
        }
